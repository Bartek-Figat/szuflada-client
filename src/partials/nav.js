      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex-shrink-0 mr-4">
            {/* Logo */}
            <li to="/" className="block" aria-label="Cruip">
            ...
            <div ref={mobileNav}>
              ...
              >
                <ul className="px-5 py-2">
                  <li>
                    <li to="/pricing" className="flex text-gray-600 hover:text-gray-900 py-2">
                      Pricing
                    </li>
                  </li>
                  <li>
                    <li to="/about" className="flex text-gray-600 hover:text-gray-900 py-2">
                      About us
                    </li>
                  </li>
                  <li>
                    <li to="/tutorials" className="flex text-gray-600 hover:text-gray-900 py-2">
                      Tutorials
                    </li>
                  </li>
                  <li>
                    <li to="/blog" className="flex text-gray-600 hover:text-gray-900 py-2">
                      Blog
                    </li>
                  </li>
